...
def args_parser():
    ...
    group_fednoro.add_argument('--level_n_lowerb', type=float, default=0.1, help='[FedNoRo] lower bound of client-level noise')
    group_fednoro.add_argument('--level_n_upperb', type=float, default=0.3, help='[FedNoRo] upper bound of client-level noise')
